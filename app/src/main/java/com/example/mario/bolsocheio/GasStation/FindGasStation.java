package com.example.mario.bolsocheio.GasStation;
/*
 ...
 */
public class FindGasStation extends ListActivity {
    /**
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.main_gas_station);
    ...
    protected void onListItemClick(ListView listView, View view, int position, long id) {
        ...
        startActivity(new Intent(FindGasStation.this, mSamples[position].activityClass));
    }
}